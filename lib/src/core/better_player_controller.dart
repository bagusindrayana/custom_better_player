...
import 'package:better_player_hls/src/configuration/better_player_controller_event.dart';
import 'package:better_player_hls/src/core/better_player_utils.dart';
import 'package:better_player_hls/src/subtitles/better_player_subtitle.dart';
import 'package:better_player_hls/src/subtitles/better_player_subtitles_factory.dart';
import 'package:better_player_hls/src/video_player/video_player.dart';
import 'package:better_player_hls/src/video_player/video_player_platform_interface.dart';
...
class BetterPlayerController {
  ...
  ///Flag used to store full screen mode state.
  set isFullScreen(bool v) => _isFullScreen = v;
  ...
  void customPostControllerEvent(BetterPlayerControllerEvent event) {
    if (!_controllerEventStreamController.isClosed) {
      _controllerEventStreamController.add(event);
    }
  }
